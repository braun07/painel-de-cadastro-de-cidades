<x-app-layout>
    ...
    <div class="p-4 bg-pink-700 rounded-lg shadow-md">
        ...
        <form action="{{ route('profile.update') }}" method="POST">
            ...
            <div class="mt-4">
                <x-label for="password" :value="__('Senha nova')" class=" font-bold text-white"/>
            ...
            <div class="mt-4">
                <x-label id="password_confirmation" :value="__('Confirme a Senha Nova')" class=" font-bold text-white"/>
                <x-input type="password"
            ...
            <div class="mt-4">
                <x-button class="block w-full font-bold text-white">
                    {{ __('Confirmar') }}
                </x-button>
            </div>
        </form>
